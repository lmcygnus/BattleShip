...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,uBAAuB;IACvB,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,iBAAiB;AACrB;AACA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,SAAS;AACb;;AAEA;IACI,aAAa;IACb,sCAAsC;IACtC,mCAAmC;IACnC,iCAAiC;IACjC,gBAAgB;IAChB,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;IACI,oCAAoC;IACpC,iBAAiB;AACrB;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,cAAc;IACd,UAAU;AACd;;AAEA;IACI,yBAAyB;IACzB,YAAY;IACZ,eAAe;IACf,iBAAiB;IACjB,kBAAkB;IAClB,kBAAkB;IAClB,eAAe;IACf,qBAAqB;IACrB,eAAe;IACf,+BAA+B;IAC/B,kBAAkB;AACtB;;AAEA;IACI,2BAA2B;IAC3B,+BAA+B;AACnC;;AAEA;IACI,0BAA0B;IAC1B,+BAA+B;AACnC;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;AACjB","sourcesContent":["body {\n    display: flex;\n    justify-content: center;\n    flex-direction: column;\n}\n\nheader {\n    display: flex;\n    justify-content: center;\n    font-size: larger;\n}\n.container {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    gap: 50px;\n}\n\n.player, .computer {\n    display: grid;\n    grid-template-columns: repeat(10, 1fr);\n    grid-template-rows: repeat(10, 1fr);\n    border: 1px solid rgb(14, 6, 124);\n    max-width: 350px;\n    min-width: 350px;\n    min-height: 350px;\n}\n\n.square {\n    border: 1px solid rgb(112, 107, 107);\n    cursor: crosshair;\n}\n\n.square:hover {\n    background-color: gray;\n}\n\n.buttons {\n    display: flex;\n    justify-content: center;\n    margin-top: 5%;\n    gap: 100px;\n}\n\nbutton {\n    background-color: #0050ec;\n    color: white;\n    font-size: 16px;\n    font-weight: bold;\n    padding: 15px 20px;\n    border-radius: 2em;\n    cursor: pointer;\n    transition: 0.1s ease;\n    border-width: 0;\n    box-shadow: 1px 5px 0 0 #0e285d;\n    width: fit-content;\n}\n  \nbutton:hover {\n    transform: translateY(-4px);\n    box-shadow: 1px 9px 0 0 #0e285d;\n}\n  \nbutton:active {\n    transform: translateY(4px);\n    box-shadow: 0px 0px 0 0 #0e285d;\n}\n\n.start {\n    display: none;\n}\n\n.reset {\n    display: none;\n}\n"],"sourceRoot":""}]);
// Exports
